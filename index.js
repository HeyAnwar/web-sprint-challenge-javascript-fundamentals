...
// This is a function nested within a function which allows it to use variables from myFunction.
...
const zooAnimals = [
  ...
  */
  const newArray = zooAnimals.map(function lowerCaseNames(item){
  ...
  */
let initialValue = 0
const totalPop = zooAnimals.reduce(function(total, amount){
...
function cuboid(item){
  CuboidMaker.call(this, item);
}
